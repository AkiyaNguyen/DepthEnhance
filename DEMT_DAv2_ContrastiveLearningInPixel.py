...
# from utils.contrastiveLearning import cont_loss

# class DAv2Fusion_MT_Trainer_ContrastiveLearningInPixel(Trainer):
#     """
#     Mean Teacher trainer with contrastive learning in pixel level feature.
...
#                  student_reliable_threshold=0.85, depth_learn_from_stu_weight=1.0, contrastive_weight=1.0, contrastive_rampup=5000.0, **kwargs) -> None:
...
#                         'contrastive_weight': [], 'contrastive_loss': [], 'loss': []}
...
#             )
#             contrastive_weight = self._get_current_contrastive_weight(
#                 global_step=batch_id + self.current_epoch * len(self.train_dataloader)
#             )
#             contrastive_loss = cont_loss(labeled_stu, unlabeled_stu, tea_labeled_output, tea_unlabeled_output)
...
#     trainer = DAv2Fusion_MT_Trainer_ContrastiveLearningInPixel(
...
#         contrastive_weight=float(cfg.get('Trainer.contrastive_weight', 1.0)),
...
#         hook_builder(MeanTeacherEvalHook_DAv2_ContrastiveLearningInPixel, eval_data_loader=val_dataloader,
...
#     parser.add_argument('--config', type=str, default='cfg/DEMT_DAv2_ContrastiveLearingInPixel.yaml', help='Path to YAML config')
...
# #     python DEMT_DAv2_ContrastiveLearningInPixel.py \
...
# #                     Hook.ExtendMLFlowLoggerHook.run_name='DEMT_DAv2_ContrastiveLearingInPixel' \
# #                     Hook.StopTrainAtEpoch.stop_at_epoch=300 \
# #                     Hook.ExtendMLFlowLoggerHook.experiment_name='DEMT_DAv2_ContrastiveLearingInPixel' \
