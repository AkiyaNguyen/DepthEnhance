...
#                  prototype_momentum=0.99, prototype_warmup_epochs=24.0, prototype_rampup_epochs=16.0,
...
#         self.prototype_rampup_length = ramp_epochs_to_iters(float(prototype_rampup_epochs), int(iters_per_epoch))
#         self.prototype_balance_weight = prototype_balance_weight
#         self.prototype_loss_weight = prototype_loss_weight
#         self.prototype_warmup_iter = ramp_epochs_to_iters(float(prototype_warmup_epochs), int(iters_per_epoch))
...
#         prototype_warmup_epochs=float(cfg.get('Trainer.prototype_warmup_epochs', 24.0)),
#         prototype_rampup_epochs=float(cfg.get('Trainer.prototype_rampup_epochs', 16.0)),
...
#     python old_DAv2_ProtoConsistency.py \
...
#                     Hook.ExtendMLFlowLoggerHook.run_name='old_DAv2_ProtoConsistency' \
#                     Hook.ExtendMLFlowLoggerHook.experiment_name='old_DAv2_ProtoConsistency' \
