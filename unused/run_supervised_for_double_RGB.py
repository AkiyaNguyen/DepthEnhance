...
#                 output = _pred_for_loss_and_metrics(self.trainer.model(img, img))
...
#         sweep_config = cfg.get('hyperparameter_sweep') or cfg.get('hyperparameter_sweep', {})
...
#     hook_builder(
#         LoggerHook,
#         logger_file=cfg.get('Hook.LoggerHook.logger_file', 'logs/depth_rgb_train_supervised.json'),
#     )
#     hook_builder(
...
#     parser = argparse.ArgumentParser(description='Fully supervised double RGB training.')
#     parser.add_argument('--optuna_trial_times', type=int, default=0, help='Optuna trials; 0 = no Optuna.')
#     parser.add_argument('--config', type=str, default='cfg/depth_rgb_train_supervised.yaml', help='Path to YAML config')
